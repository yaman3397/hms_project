  ...
  if (empty($error)) {
    ...
    try {
      ...
      if ($stmt->execute()) {
        ...
        echo "<script>window.location.href='newborn.php';</script>";
        exit();
      }
  ...
  <div class="glass-card">
    ...
    <form method="POST" class="row g-3" onsubmit="return validateForm()">
      ...
      <div class="col-md-4">
        ...
        <input type="text" name="mother_mr" class="form-control" value="<?= htmlspecialchars($_POST['mother_mr'] ?? '') ?>" placeholder="Optional">
      </div>
