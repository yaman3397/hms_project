...
<div class="container mt-4" id="printable">
    ...
    <table class="table table-sm">
        ...
        <tr>
            <td><span class="label">Admit Date:</span> <?= htmlspecialchars($invoice['admit_date'] ?? '') ?> <?= htmlspecialchars($invoice['admit_time'] ?? '') ?></td>
            <td><span class="label">Discharge Date:</span> <?= htmlspecialchars($invoice['discharge_date'] ?? '') ?> <?= htmlspecialchars($invoice['discharge_time'] ?? '') ?></td>
        </tr>
